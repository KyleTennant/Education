...
int main()
{
	...
	outputFile << "Total Deposits:    " << totalDeposits << endl;
	outputFile << "Total Withdrawals: " << totalWithdrawals << endl;
	outputFile << "Total Interest:    " << totalInterest << endl;
	outputFile << "Ending Balance:    " << moEndBal << endl;

	// Close the file
	outputFile.close();

	cout << " " << endl;
	cout << "Thank you! Your Statement has been filed." << endl;
